...
import testsuit as poc_simpletest
...
def load_data_table(data_url):
    ...
    data_tokens = [line.split(b',') for line in data_lines]
...
def test_hierarchical24():
    ...
    for num_clusters, expected_county_tuple in hierdata_24:
        ...
        # Prepare test
        error_message = "Testing hierarchical_clustering on 24 county table, num_clusters = " + \
            str(num_clusters)
        error_message += "\nStudent county tuples: " + \
            str(student_county_tuple)
        error_message += "\nExpected county tuples: " + \
            str(expected_county_tuple)
        suite.run_test(student_county_tuple ==
                       expected_county_tuple, True, error_message)
...
def test_kmeans():
    ...
    kmeansdata_24 = [
        ...
        [10, 1,
         set(
             [('34017', '36061'),
              ('06029', '06037', '06075'),
              ('11001', '24510', '34013', '34039', '51013', '51760', '51840', '54009'),
              ('06059',),
              ('36047',),
              ('36081',),
    ...
    for num_clusters, num_iterations, expected_county_tuple in kmeansdata_24:
        ...
        # compute student answer
        student_clustering = student.kmeans_clustering(
            cluster_list, num_clusters, num_iterations)
        student_county_tuple = set_of_county_tuples(student_clustering)

        # Prepare test
        error_message = "Testing kmeans_custering on 24 county table, num_clusters = " + \
            str(num_clusters)
